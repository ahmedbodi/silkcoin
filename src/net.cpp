...
static const char *strDNSSeed[][2] = {
    {"107.170.61.197", "107.170.61.197"},
    {"107.170.73.238", "107.170.73.238"},
    {"greencoin.crypto-expert.com", "greencoin.crypto-expert.com"},
    {"45.55.250.196", "45.55.250.196"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("silkcoin-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Silkcoin is probably already running."), addrBind.ToString().c_str());
        else
